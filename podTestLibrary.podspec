...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/wangqiuwei/podTestLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'wangqiuwei' => '2607060800@qq.com' }
  s.source           = { :git => 'https://github.com/wangqiuwei/podTestLibrary.git', :tag => s.version.to_s }
